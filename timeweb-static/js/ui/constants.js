...
const DEVELOPER_MESSAGES = Object.freeze([
  {
    id: "update-v28-2026-08-19",
    version: "v28",
    major: true,
    date: "19 августа 2026",
    title: "Умнее маскоты, обучение и честный прогресс",
    intro: "Большой апдейт делает первые партии понятнее, маскотов живее, а прогресс и таблицы лидеров — точнее.",
    items: [
      "Маскоты получили больше характера: новые яркие образы, десятки реплик на разные ситуации, обращения по имени, реакции на ошибки, комбо и начало уровня.",
      "Обучение стало интерактивным и следит за действиями игрока: категории, ручные переносы, двойной тап, колода, отмена и подсказка.",
      "За установку Словасьянса на домашний экран теперь выдаётся 250 XP; в игре появился короткий гайд по установке.",
      "Перед ежедневным и особыми режимами показываются условия, ежедневный расклад вынесен отдельной крупной кнопкой в заданиях.",
      "Исправлены звёзды, уровни и дуэльная статистика, конфликты похожих категорий, перезапуск расклада, автокомбо и несколько проблем iPhone/PWA."
    ],
  },
  {
    ...
    items: [
      "Маскоты-боссы стали мультяшными и теперь стабильно показывают свои фирменные фразы перед финалами глав.",
      "Экран победы стал чище: убраны лишние строки, кнопка «Поделиться» переехала вниз, а XP начисляется поэтапно с яркими бонусами.",
      "В профиле можно один раз указать дату рождения. В этот день откроется уникальный маскот, поздравление и неделя приятных бонусов.",
      "Исправлены нижняя панель на iPhone, фон реплики маскота, подсчёт наград за входы и запрет перетаскивания уже собранной категории из слота.",
      "Обновлены названия и описания некоторых особых уровней, чтобы они звучали понятнее и естественнее по-русски."
    ],
  },
  {
