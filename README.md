...
## Игровые коллекции с картинками

Раздел «Коллекция» теперь содержит отдельные игровые наборы: Животные, Природа, Еда, Космос и Эмоции. В этих раскладах сами игровые карты — emoji-картинки, которые нужно объединять по смысловым категориям. Это отдельный игровой режим, а не косметическое оформление обычных словесных карт.
