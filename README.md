...
- Аватар игрока можно выбрать из набора emoji; он отображается в профиле и на карточке приглашения.
- Для лицевых карточек доступны emoji-наборы: без картинок, микс, животные, природа, еда, космос и эмоции. В каскаде картинка скрывается, чтобы слово оставалось читаемым.
...
Вкладка «Энциклопедия» объединяет две базы: словесные категории и категории картинок. Сверху показывается общий прогресс, а внутри есть переключатели «Слова» и «Картинки». В «Картинках» доступны 10 тематических наборов и 60 визуальных категорий.
